...
// O(1)
// El algoritmo tiene solo un paso
...
// O(1)
// Devuelve un valor que ya está definido
...
// O(n)
// Dependiendo del tamaño de la lista, son los pasos deberá correr
...
// O(1)
// Se hace al principio de la lista
...
// O(1)
// Se hace inmediatamente en el primer elemento de la lista
